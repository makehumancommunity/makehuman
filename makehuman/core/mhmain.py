...
class MHApplication(gui3d.Application, mh.Application):
    ...
    def updateCaption(self):
        ...
        filename = self.selectedHuman.filename
        if filename is None:
            filename = "Untitled"
        if mh.isRelease():
            self.setCaption(
    ...
    def resetHuman(self):
        if self.selectedHuman.modified:
